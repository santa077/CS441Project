...
//FlightList txt file data/information grabber
public class FlightList
{
  //Flight parameter variables for storing tokens per whitespace
  private int date;
  ...
  public FlightList()
  {
    //create ArrayList list to store flight objects
  ...
  // getFlightList for returning generated ArrayList list
  ...
  // simple printList function to pull initial db of flights and generate a display, ended up not having to use
