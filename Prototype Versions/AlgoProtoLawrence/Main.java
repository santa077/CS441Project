...
class Main 
{
    ...
    public static void Parameters(String initialPort, String finalPort, String flightEarliestDate,
            String flightLatestDate, int maxTransfers, int lowCostPref, int layoverPref, int flightTimePref) 
    {
    ...
    {  
        ...
        int maxTransfers = 0, lowCostPref = 0, layoverPref = 0, flightTimePref = 0;
        resetFlag = false;
      ...
      do 
        {
            ...
            if(!resetFlag)
            {
                if(twoWayFlightCheck)                                             ///////////error says local may not have been initialized
                {
                    ...
                    do
                    {
                        ...
                        layoverPref = getLayoverTimePref();
          ...
          ///////////////similar localized variable error here for all preference inputs
                ...
                System.out.println("Layover/Direct preference is: " + layoverPref);
                System.out.println("Flight time preference is: " + flightTimePref);

                algorithm alg = new algorithm();
                alg.readfile();
                alg.findPref(lowCostPref, layoverPref, flightTimePref);
